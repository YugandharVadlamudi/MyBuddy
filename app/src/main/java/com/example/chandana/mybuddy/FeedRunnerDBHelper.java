...
//            super(context, DATABASE_NAME, null, DATABASE_VERSION);
    ...
    public void onCreate(SQLiteDatabase db) {
        String createSignUpTable = "CREATE TABLE " + Table_name + " ( " + COLUMN_fname + " " + TEXT_TYPE + "," + COLUMN_lname + " " + TEXT_TYPE + "," + COLUMN_EMAIL + " " + TEXT_TYPE +" PRIMARY KEY "+ "," + COLUMN_PASSWORD + " " + TEXT_TYPE + ","+COLUMN_IMAGE_PATH+" "+TEXT_TYPE+" DEFAULT 'NP' "+");";
        String createContactTable = "CREATE TABLE "+TABLE_CONTACTS+" ( "+CONTACTS_COLUMN_NAME +" "+TEXT_TYPE+","+CONTACTS_COLUMN_AGE+" "+NUMBER_TYPE+","
                +CONTACTS_COLUMN_PHONENUMBER+" "+TEXT_TYPE+" PRIMARY KEY "+","+CONTACTS_COLUMN_EMAIL+" "+TEXT_TYPE+","+CONTACTS_COLUMN_PROFESSION+" "+TEXT_TYPE+","
                +CONTACTS_COLUMN_BLOODGROUP+" "+TEXT_TYPE+","+CONTACTS_COLUMN_WORKING+" "+TEXT_TYPE+","+CONTACTS_COLUMN_CITY+" "+TEXT_TYPE+","
                +CONTACTS_COLUMN_STATE+" "+TEXT_TYPE+","+CONTACTS_COLUMN_COUNTRY+" "+TEXT_TYPE+","+CONTACTS_COLUMN_FAVOURIT+" "+TEXT_TYPE+" DEFAULT 'NF' "+","
                +CONTACTS_COLUMN_IMGPATH+" "+TEXT_TYPE+","+CONTACTS_COLUMN_USERID+" "+TEXT_TYPE+" );";
    ...
    {
        String deleteContacts="DELETE FROM "+TABLE_CONTACTS;
        SQLiteDatabase sq=this.getWritableDatabase();
        sq.execSQL(deleteContacts);
    }
}